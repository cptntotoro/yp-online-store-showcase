...
class CartItemRepositoryTest {
    ...
    private final UUID productUuid1 = UUID.fromString("22222222-2222-2222-2222-222222222222");
    private final UUID productUuid2 = UUID.fromString("33333333-3333-3333-3333-333333333333");
    ...
    void shouldDeleteItemByCartUuidAndProductUuid() {
        StepVerifier.create(cartItemRepository.deleteByCartUuidAndProductUuid(cartUuid, productUuid1))
                .verifyComplete();

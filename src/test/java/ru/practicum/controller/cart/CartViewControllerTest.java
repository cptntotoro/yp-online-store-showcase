...
class CartViewControllerTest extends BaseControllerTest {
    ...
    void showCart_ShouldReturnCartView_WhenCartExists() {
        ...
        cartDto.setTotalPrice(testTotalPrice);
    ...
    void removeFromCart_ShouldRedirect() {
        when(cartService.removeFromCart(TEST_USER_UUID, testProductUuid))
        ...
        verify(cartService).removeFromCart(TEST_USER_UUID, testProductUuid);
    }

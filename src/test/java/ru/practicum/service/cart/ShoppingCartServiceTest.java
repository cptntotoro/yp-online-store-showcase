...
class ShoppingCartServiceTest {
    ...
    void getTotalPrice_shouldReturnCorrectTotal() {
        cartService.add(product1, 2); // 2 x 100 = 200
        cartService.add(product2, 1); // 1 x 200 = 200

        assertEquals(400.0, cartService.getTotalPrice(), 0.001);
    }
    ...
    void sessionScoped_shouldMaintainSeparateCarts() {
        ...
        cartService.add(product1, 1);
        anotherCartService.add(product2, 1);
